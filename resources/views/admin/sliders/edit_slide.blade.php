				      		...
				      		<div class="form-group col-md-6">
				        		...
				        		<input type="file" class="form-control" id="image" name="image" accept="image/*">
                              	...
                              	@if($slider->image && file_exists('uploads/slider/'.$slider->image))
                                	<a href="{{ url('uploads/slider/'.$slider->image) }}" target="_blank"><img src="{{ url('uploads/slider/'.$slider->image) }}" class="form-img"></a>
                                @endif
				      		</div>
                          	...
                          	<div class="form-group col-md-6">
				        		...
				        		<input type="file" class="form-control" id="mobile_image" name="mobile_image" accept="image/*">
                              	...
                              	@if($slider->mobile_image && file_exists('uploads/slider/'.$slider->mobile_image))
                                	<a href="{{ url('uploads/slider/'.$slider->mobile_image) }}" target="_blank"><img src="{{ url('uploads/slider/'.$slider->mobile_image) }}" class="form-img"></a>
                                @endif
				      		</div>
                          	<!-- End Mobile Image -->
